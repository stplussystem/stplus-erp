    ...
    <Document>
      <Page size={pdfPageSize} style={styles.pageBoxMode}>
        ...
        {isVisible("vendorInfo") && (
          <View style={[absoluteStyle(layout.vendorInfo), getA4BoxFillStyle(layout.vendorInfo, a4FillOpts)]}>
        ...
        {isVisible("footerCondition") && (
          <View style={[absoluteStyle(layout.footerCondition), getA4BoxFillStyle(layout.footerCondition, a4FillOpts)]}>
