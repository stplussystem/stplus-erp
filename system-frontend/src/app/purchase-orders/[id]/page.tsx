        ...
        <div className="flex items-center gap-3">
          ...
          {isPending && canApprove && (
            <button
              ...
              className="flex justify-center h-10 px-5 py-2  w-full md:w-auto gap-2 text-sm font-medium items-center text-white bg-green-600 hover:bg-green-800 shadow-sm shadow-green-600/20 rounded-full cursor-pointer transition-all hover:scale-102 transition-transform disabled:opacity-50"
            >
              {isApproving ? (
