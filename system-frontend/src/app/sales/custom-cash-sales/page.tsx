        ...
        <div className="p-4 border-b border-border flex justify-between items-center bg-muted/50">
          <div className="relative w-full max-w-sm">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 rounded-xl h-10 border border-border focus:border-teal-500 focus:ring-2 focus:ring-teal-100 outline-none text-sm transition-colors"
            />
          </div>
        </div>
