    ...
    <div className="w-full max-w-full px-4 py-4 text-foreground">
                      ...
                      <div className="flex items-center justify-center gap-1">
                        ...
                        {doc.status === "Approved" && (
                          <AppTooltip label="คืนสินค้าจากใบลดหนี้นี้">
                            ...
                            >
                              <button className="p-2 text-muted-foreground hover:text-rose-500 hover:bg-rose-50 rounded-xl transition-colors cursor-pointer">
      ...
      <AppConfirmDialog
        ...
        onSecondary={() => {
          ...
          setApproveTarget(null);
          if (id) router.push(`/sales/credit-notes/${id}/edit`);
        }}
      />
