      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 min-h-[500px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8 p-5 border border-fuchsia-100 rounded-xl bg-fuchsia-50/40">
          <div>
            ...
            {customLogoUrl ? (
              ...
              <button
                ...
                className="w-full h-10 px-4 rounded-xl border border-dashed border-fuchsia-300 bg-white text-xs font-bold text-fuchsia-600 hover:bg-fuchsia-50 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
                {uploadingLogo ? (
                  <Loader2 className="w-4 h-4 animate-spin" />
                ) : (
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full h-10 px-4 text-sm rounded-xl border border-slate-200 focus:border-fuchsia-500 focus:ring-2 focus:ring-fuchsia-100 outline-none"
          ...
          <div className="md:col-span-3">
            ...
            <textarea
              rows={2}
              className="w-full p-3 text-sm rounded-xl border border-slate-200 outline-none resize-none focus:border-fuchsia-500 focus:ring-2 focus:ring-fuchsia-100"
            ...
            <div className="flex items-center gap-2">
              ...
              <AppTooltip label="เพิ่มลูกค้าใหม่แบบด่วน">
                <button
                  ...
                  className="h-10 w-10 flex items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-500 hover:text-fuchsia-600 hover:border-fuchsia-300 hover:bg-fuchsia-50 cursor-pointer transition-all shrink-0"
                >
