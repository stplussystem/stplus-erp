...
function ArAgingReportPageContent() {
        ...
        {loading ? (
          ...
          <div className="bg-card rounded-2xl shadow-sm border border-border p-5">
            <div className="text-center py-10">
              ...
              <p className="text-muted-foreground">ไม่มีลูกหนี้ค้างชำระตามเงื่อนไขที่เลือก</p>
            </div>
          </div>
        ) : (
...
export default function ArAgingReportPage() {
  return (
    <RoleRouteGuard permission="view_reports_ar_aging">
      <ArAgingReportPageContent />
    </RoleRouteGuard>
  );
}
